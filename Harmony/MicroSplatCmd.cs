            ...
            switch (_params[0])
            {
                ...
                case "layer":
                    ...
                    switch (_params[2])
                    {
                        ...
                        case "slope-curve": layer.slopeCurve = ParseAnimationKeys(_params[3]); break;
                        case "height-curve": layer.heightCurve = ParseAnimationKeys(_params[3]); break;
                        case "erosion-curve": layer.erosionMapCurve = ParseAnimationKeys(_params[3]); break;
                        case "cavity-curve": layer.cavityMapCurve = ParseAnimationKeys(_params[3]); break;
